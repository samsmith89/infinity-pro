...
function infinity_front_page_widgets()
{
	...
	genesis_widget_area('front-page-1', array(
		'before' => '<div id="front-page-1" class="front-page-1"><video playsinline autoplay muted loop poster="/wp-content/themes/infinity-pro/images/hero-vid-poster-768x432.png" id="bgvideo" width="x" height="y">
            <source src="/wp-content/themes/infinity-pro/images/vid-hero.mp4" type="video/mp4">
        </video><div class="image-section widget-area fadeup-effect"><div class="wrap">',
		'after' => '</div></div></div>',
	));

	// Removed "fadeup-effect" from the second div
	genesis_widget_area('front-page-2', array(
		'before' => '<div id="front-page-2" class="front-page-2"><div class="solid-section flexible-widgets widget-area' . infinity_widget_area_class('front-page-2') . '"><div class="wrap">',
		'after' => '</div></div></div>',
	));
